...
import { userColumns, users } from '@/lib/data';
import {
  Card,
  CardBody,
  CardFooter,
  ...
  return (
    <>
      <DashboardLayout title="Dashboard" description="Welcome to the Dashbaord">
        <Card className="border-[#3e114e] border-2 rounded-[8px] inline-block">
          <CardHeader className="text-[24px]">Users</CardHeader>
          <CardBody>12</CardBody>
          <CardFooter>Total number of users</CardFooter>
        </Card>
        <Table>
