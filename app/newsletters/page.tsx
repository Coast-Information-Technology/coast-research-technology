  ...
  return (
    <>
      <DashboardLayout title="Dashboard" description="Welcome to the Dashbaord">
        <h1 className="font-bold text-[20px]">All Newsletter</h1>
        <Table
        ...
        >
          <TableHeader>
            ...
            <TableColumn className="text-left text-[12px]" key="user_id">
              USER ID
            </TableColumn>
            <TableColumn className="text-left text-[12px]" key="post_id">
              POST ID
            </TableColumn>
            <TableColumn className="text-left text-[12px]" key="post_title">
              POST TITLE
            </TableColumn>
